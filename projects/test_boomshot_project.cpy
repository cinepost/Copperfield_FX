...
links = [
	...
	("/comp1/brick1", "/comp1/blend1", 0, 0, ), # connect brick1 to input 0 of blend1
	("/comp1/brick2", "/comp1/blend1", 0, 1, ), # connect brick2 to input 1 of blend1

	("/comp1/blend1", "/comp1/blend2", 0, 0, ), # connect blend1 to input 0 of blend2
	("/comp1/brick3", "/comp1/blend2", 0, 1, )  # connect brick3 to input 1 of blend2
]

output = {
	"node_path": "/comp1/blend2",
