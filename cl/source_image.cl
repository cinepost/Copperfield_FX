...
__kernel void run(__read_only image2d_t img_in, __write_only image2d_t img_out, const int in_width, const int in_height, const int out_width, const int out_height)
{
