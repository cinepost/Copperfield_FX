...
class ParameterStringWidget(ParameterBaseWidget):
    def __init__(self, parent, parm):
        ...
        if self.parm.parmTemplate().stringType() is StringParmType.FileReference:
        ...
        elif self.parm.parmTemplate().stringType() is StringParmType.NodeReference:
    ...
    @QtCore.pyqtSlot()
    def updateWidget(self):
        self.line_edit.setText(self.parm.evalAsString())
