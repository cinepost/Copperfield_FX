...
_pkg_config = {
    'pyqt_bin_dir':      '/Users/max/dev/Copperfield_FX/venv/bin/../bin',
    'pyqt_config_args':  '',
    'pyqt_mod_dir':      '/Users/max/dev/Copperfield_FX/venv/lib/python2.7/site-packages/PyQt4',
    ...
    'pyqt_sip_dir':      '/Users/max/dev/Copperfield_FX/venv/bin/../share/sip/PyQt4',
    ...
    'qt_archdata_dir':   '/usr/local/Cellar/qt/HEAD',
    'qt_data_dir':       '/usr/local/Cellar/qt/HEAD',
    'qt_dir':            '/usr/local/Cellar/qt/HEAD',
    'qt_edition':        'free',
    'qt_framework':      1,
    'qt_inc_dir':        '/usr/local/Cellar/qt/HEAD/include',
    'qt_lib_dir':        '/usr/local/Cellar/qt/HEAD/lib',
    'qt_threaded':       1,
    'qt_version':        0x040806,
    'qt_winconfig':      'shared'
}
...
_default_macros = {
    ...
    'INCDIR_QT':                '/usr/local/Cellar/qt/HEAD/include',
    'INCDIR_X11':               '',
    ...
    'LIBDIR':                   '',
    'LIBDIR_OPENGL':            '',
    'LIBDIR_QT':                '/usr/local/Cellar/qt/HEAD/lib',
    'LIBDIR_X11':               '',
    'LIBS':                     '',
    'LIBS_CONSOLE':             '',
    'LIBS_CORE':                '',
    ...
    'MKDIR':                    'mkdir -p',
    'MOC':                      '/usr/local/Cellar/qt/HEAD/bin/moc',
    'RANLIB':                   'ranlib -s',
    'RPATH':                    '',
    'STRIP':                    ''
}
