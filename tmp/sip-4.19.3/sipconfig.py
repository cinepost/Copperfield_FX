...
_pkg_config = {
    'arch':               '',
    'default_bin_dir':    '/Users/max/dev/Copperfield_FX/virtualenv/bin/../bin',
    'default_mod_dir':    '/Users/max/dev/Copperfield_FX/virtualenv/lib/python2.7/site-packages',
    'default_sip_dir':    '/Users/max/dev/Copperfield_FX/virtualenv/bin/../share/sip',
    'deployment_target':  '',
    'platform':           'macx-g++',
    'py_conf_inc_dir':    '/usr/local/Cellar/python/2.7.13/Frameworks/Python.framework/Versions/2.7/include/python2.7',
    'py_inc_dir':         '/usr/local/Cellar/python/2.7.13/Frameworks/Python.framework/Versions/2.7/include/python2.7',
    'py_lib_dir':         '/usr/local/Cellar/python/2.7.13/Frameworks/Python.framework/Versions/2.7/lib/python2.7/config',
    'py_version':         0x02070d,
    'qt_framework':       0,
    'sip_bin':            '/Users/max/dev/Copperfield_FX/virtualenv/bin/../bin/sip',
    'sip_config_args':    '',
    'sip_inc_dir':        '/Users/max/dev/Copperfield_FX/virtualenv/bin/../include/python2.7',
    'sip_mod_dir':        '/Users/max/dev/Copperfield_FX/virtualenv/lib/python2.7/site-packages',
