...
_pkg_config = {
    'pyqt_bin_dir':      '/Users/max/dev/Copperfield_FX/virtualenv/bin/../bin',
    'pyqt_config_args':  '--qmake=/usr/local/bin/qmake --use-arch x86_64',
    'pyqt_mod_dir':      '/Users/max/dev/Copperfield_FX/virtualenv/lib/python2.7/site-packages/PyQt4',
    ...
    'pyqt_sip_dir':      '/Users/max/dev/Copperfield_FX/virtualenv/bin/../share/sip/PyQt4',
    ...
    'qt_archdata_dir':   '/usr/local/Cellar/qt@4/4.8.7_1',
    'qt_data_dir':       '/usr/local/Cellar/qt@4/4.8.7_1',
    'qt_dir':            '/usr/local/Cellar/qt@4/4.8.7_1',
    'qt_edition':        'free',
    'qt_framework':      1,
    'qt_inc_dir':        '/usr/local/Cellar/qt@4/4.8.7_1/include',
    'qt_lib_dir':        '/usr/local/Cellar/qt@4/4.8.7_1/lib',
    'qt_threaded':       1,
    'qt_version':        0x040807,
    'qt_winconfig':      'shared'
}
...
_default_macros = {
    ...
    'INCDIR_QT':                '/usr/local/Cellar/qt@4/4.8.7_1/include',
    'INCDIR_X11':               '',
    ...
    'LIBDIR':                   '',
    'LIBDIR_OPENGL':            '',
    'LIBDIR_QT':                '/usr/local/Cellar/qt@4/4.8.7_1/lib',
    'LIBDIR_X11':               '',
    'LIBS':                     '',
    'LIBS_CONSOLE':             '',
    'LIBS_CORE':                '',
    ...
    'MKDIR':                    'mkdir -p',
    'MOC':                      '/usr/local/Cellar/qt@4/4.8.7_1/bin/moc',
    'RANLIB':                   'ranlib -s',
    'RPATH':                    '',
    'STRIP':                    ''
}
